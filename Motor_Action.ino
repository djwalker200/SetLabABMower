...
void Motor_Action_Go_Slow_Speed()     {
      ...
      analogWrite(ENBPin,  PWM_Slow_Speed_LH);                       // AnalogWrite sends PWM signals Speed = 0-255  (255 is max speed)
...
void SetPins_ToGoForwards()     {                                 // Motor Bridge pins are set for both motors to move forwards.
  digitalWrite(IN1Pin, LOW);                                      // Motor Bridge pins are set to high or low to set the direction of movement
